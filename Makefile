#############################################################################
# Makefile for building: CServ
# Generated by qmake (3.0) (Qt 5.0.1) on: Sat Nov 16 14:32:04 2013
# Project:  CServ.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile CServ.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
Makefile: CServ.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/CServ1.0.0 || $(MKDIR) .tmp/CServ1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CServ1.0.0/ && $(COPY_FILE) --parents init.h .tmp/CServ1.0.0/ && $(COPY_FILE) --parents main.cpp init.cpp .tmp/CServ1.0.0/ && (cd `dirname .tmp/CServ1.0.0` && $(TAR) CServ1.0.0.tar CServ1.0.0 && $(COMPRESS) CServ1.0.0.tar) && $(MOVE) `dirname .tmp/CServ1.0.0`/CServ1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CServ1.0.0
...
compiler_moc_header_make_all: moc_init.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_init.cpp
moc_init.cpp: /usr/include/qt5/QtCore/QtCore \
		...
		init.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) init.h -o moc_init.cpp
